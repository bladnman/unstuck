...
Everything lives in one central folder (`~/Documents/unstuck/` via iCloud), accessible from any project directory. Items accumulate context over time. Sessions are logged. Memory compounds — the skill learns how you think and what you care about, so every conversation starts warm.
